    ...
    const [width, height] = useMemo(
        () =>
            phone && typeof window !== 'undefined'
                ? [window.screen.availWidth - 48, window.screen.availWidth - 48]
                : [400, 400],
        [phone]
    );
